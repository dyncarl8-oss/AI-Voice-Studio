...
export default function Home() {
  ...
  const handleRename = (id: string) => {
    const model = voiceModels.find((v) => v._id === id);
    if (model) {
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-white dark:bg-card border border-border/50 overflow-hidden">
                <img
                  src={logoUrl}
                  alt="Logo"
              ...
              {isLoadingHistory ? (
                ...
                <div className="grid gap-4">
                  {generatedAudioHistory.map((audio, index) => (
                    <div key={audio._id} className="max-w-3xl">
                      <div className="mb-2">
                      ...
                      <AudioPlayer
                        ...
                        onDownload={() => {
                          ...
                          link.download = `speech-${audio._id}.mp3`;
                          link.click();
                        }}
                      />
                    </div>
